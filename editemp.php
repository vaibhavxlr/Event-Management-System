...
$id=$_GET['emp_id'];
include('db.php');
$qq = mysqli_query($con,"SELECT * FROM `employee` WHERE emp_id='$id' ");
...
<tr>
<td><font size="5">Emp Id: </font>
<input type="text" name="emp_id" class="form-control" value="<?php echo $res['emp_id']?>"/></td>
</tr>
<tr>
<td><font size="5">Name: </font>
<input type="text" name="ename" class="form-control" value="<?php echo $res['ename']?>"/></td>
</tr>
<tr>
<td><font size="5">Gender: </font>
<input type="text" name="gender" class="form-control" value="<?php echo $res['gender']?>"/></td>
</tr>
<tr>
<td><font size="5">Date of birth: </font>
<input type="date" name="dob" class="form-control" value="<?php echo $res['dob']?>"/></td>
</tr>
<tr>
<td><font size="5">Phone Number: </font>
<input type="text" name="pno" class="form-control" value="<?php echo $res['pno']?>"/></td>
</tr>
<tr>
<td><font size="5">Email: </font>
<input type="email" name="email" class="form-control" value="<?php echo $res['email']?>"/></td>
</tr>
<tr>
<td>
<font size="5">Occupation: </font>
<input type="text" name="occp" class="form-control" value="<?php echo $res['occp']?>"/>
</td>
</tr>
<tr>
<td>
<font size="5">Address of correspondence: </font>
<input type="text" name="addr" class="form-control" value="<?php echo $res['addr']?>"/>
</td>
</tr>
</table><br>
<div>
<input class="btn btn-primary" type="submit" name="add" value="Submit">
    ...
    if(isset($_POST['add']))
    {
      ...
      $qry=mysqli_query($con,"UPDATE `employee` SET `emp_id`='$i',`ename`='$e',`gender`='$g',`dob`='$d',`pno`='$p',`email`='$em',`occp`='$o',`addr`='$a' WHERE emp_id='$id'") or die(mysqli_error($con));
